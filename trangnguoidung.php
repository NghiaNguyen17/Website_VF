...
<body>
    ...
    <section class="trangchu" id="trangchu">
        <header>
            ...
            <ul>
				...
				<li><a href="#"><button class="gachduoi">Về vietfinance</button></a></li>
                <li><a href="#"><button class="gachduoi">Sản phẩm</button></a></li>
                <li><a href="#"><button class="gachduoi">Bảng giá</button></a></li>
				<li><a href="#"><button class="gachduoi">Đánh giá</button></a></li>
            </ul>
			<ul>
				<li><p class="tennguoidung">Xin chào, <strong><?php echo $_SESSION['user_name'] ?></strong></p></li>
				<li class="buttondangnhap"><a href="user/dangxuat.php"><button>Đăng xuất</button></a></li>
			</ul>
        </header>
        <div class="content">
            <div class="textBox">
	...
	<section class="wrappergioithieu">
			...
			<div class="container">
				...
				<div class="package">
					<div class="item">
						...
						<div class="unit">(VNĐ/năm)</div>
						<ul>
							<li><i class="fa-regular fa-star"></i>Phân tích & định giá cổ phiếu</li>
							<li><i class="fa-regular fa-star"></i>Bộ lọc cổ phiếu tăng trưởng</li>
							<li><i class="fa-regular fa-star"></i>Cảnh báo thông minh</li>
						</ul>
						<a href="#" class="button">Chi tiết</a>
					</div>
					<div class="item">
						<div class="package__rcm">Gói khuyên dùng</div>
						<div class="title">Nâng cao</div>
						<div class="line"></div>
						<div class="price rcm">3.050.000</div>
						<div class="unit rcm">(VNĐ/năm)</div>
						<ul>
							<li><i class="fa-regular fa-star"></i>Tất cả tính năng ở gói Cơ bản</li>
							<li><i class="fa-regular fa-star"></i>Cập nhật giá & phân tích liên<br> tục trong phiên</li>
							<li><i class="fa-regular fa-star"></i>Cảnh báo giao dịch của cá mập</li>
							<li><i class="fa-regular fa-star"></i>Cảnh báo thay đổi định giá của<br> các doanh nghiệp</li>
							<li><i class="fa-regular fa-star"></i>Phân tích so sánh Xu hướng<br> dòng tiền nhiều cổ phiếu</li>
						</ul>
						<a href="#" class="button">Chi tiết</a>
					</div>
					<div class="item">
						...
						<div class="line"></div>
						<div class="price">5.050.000</div>
						<div class="unit">(VNĐ/năm)</div>
						<ul>
							<li><i class="fa-regular fa-star"></i>Tất cả tính năng ở gói Nâng cao</li>
							<li><i class="fa-regular fa-star"></i>Chuyên viên tư vấn & hỗ trợ</li>
							<li><i class="fa-regular fa-star"></i>Bộ lọc đánh giá 360</li>
						</ul>
						<a href="#" class="button">Chi tiết</a>
					</div>
				</div>
        ...
        <div class="groupcauhoi" id="faq"> 
            <div class="question q1"> 
                ...
                <div id="q1" class="panel-collapse collapse"> 
                    <div class="panel-answer"> 
                        <p>Quý khách sẽ được dùng thử 15 ngày miễn phí hoàn toàn 20 phân hệ phần mềm MISA AMIS 
            ...
            <div class="question q2"> 
                ...
                <div id="q2" class="panel-collapse collapse"> 
                    <div class="panel-answer"> 
                        <p>Phần mềm MISA AMIS Kế toán cho phép dùng được nhiều dữ liệu nhưng khi in báo cáo 
            ...
            <div class="question q3"> 
                ...
                <div id="q3" class="panel-collapse collapse"> 
                    <div class="panel-answer">
                        <p>Phần mềm hiện đã có ứng dụng MISA AMIS Kế toán cài đặt hoàn toàn miễn phí 
            ...
            <div class="question q4"> 
                ...
                <div id="q4" class="panel-collapse collapse"> 
                    <div class="panel-answer">
                        <p>Với tâm thế phụng sự khách hàng một cách hiệu quả nhất, MISA đã và đang thiết lập 
                        các kênh hỗ trợ kỹ thuật trên đa nền tảng nhằm phục vụ khách hàng nhanh chóng, kịp thời. 
                        Khi cần được hỗ trợ, anh chị có thể liên hệ: Tổng đài MISA SUPPORT, Cộng đồng hỗ trợ qua 
                        Facebook, Fanpage MISA AMIS Kế toán. </p> 
                    </div> 
                </div> 
            </div>
            ...
            <div class="question q5"> 
                ...
                <div id="q5" class="panel-collapse collapse"> 
                    <div class="panel-answer">
                       <p>MISA AMIS Kế toán có thể sử dụng trên cả hệ điều hành Windows và MacOS. </p> 
                    </div> 
                </div> 
            </div>
