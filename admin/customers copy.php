    ...
    <form action="" method="POST">
        ...
        <div class="container">
            <div class="name">
                ...
                <span><input type="text" placeholder="KH" name="packageName" class="input"></span>
            </div>
            <div class="price">
            ...
            <div class="packageFeature">
                ...
                <span><input type="text" placeholder="SDT" name="packageFeature2" class="Feature"></span>
                <label>Nhập căn cước công dân</label>
                <span><input type="text" placeholder="CCCD" name="packageFeature3" class="Feature"></span>
                <label>Nhập địa chỉ</label>
                <span><input type="text" placeholder="Địa chỉ" name="packageFeature4" class="Feature"></span>
            </div>
            ...
            if(isset($_POST['submit'])){
                ...
                if(isset($_POST['packageFeature4']))
                    ...
                    $sql = "INSERT INTO KHACHHANG (MAKH, HODEM, TEN, SDT, CCCD, DIACHI) 
                    VALUES ('$packageName','$packageCost','$packageFeature1','$packageFeature2','$packageFeature3', '$packageFeature4')";
                    if(sqlsrv_query($conn, $sql)){
                        echo "<p class=\"alert\">Thêm mới thành công</p>";
                        echo '<a href="customers.php">Hoàn thành</a>';
                    }
                    else
                    sqlsrv_close($conn);}
            ?>
