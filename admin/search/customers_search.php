    ...
    <section class="dashboard">
        ...
        <div class="main">
            <div class="topbar">
                ...
                <div class="search">
                    <form action="customers_search.php">
                    <label>
            ...
            <div class="details">
                <div class="recentOrders">
                    ...
                    <table class="user_list">
                        ...
                        <?php
                        $search='%'.$search.'%';
                        $sql="SELECT *  FROM KHACHHANG WHERE MAKH LIKE '%$search%' OR HODEM LIKE '%$search%' OR TEN LIKE '%$search%' OR SDT LIKE '%$search%' OR CCCD LIKE '%$search%' OR DIACHI LIKE '%$search%' ORDER BY MAKH";
                        ...
                        if($stmt){
                            while($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)){
                                ...
                                echo '<td>'.'<a href="../editCustomers.php">'.'Sửa'.'</a>'.'<a href="../dltCustomers.php">'.'Xóa'.'</a>'.'</td>';
                                echo '</tr>';
                            }
                        }
                        ?>
