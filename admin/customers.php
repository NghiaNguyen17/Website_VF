    ...
    <section class="dashboard">
        ...
        <div class="main">
            <div class="topbar">
                ...
                <div class="search">
                    <form action="search/customers_search.php">
                    <label>
            ...
            <div class="details">
                <div class="recentOrders">
                    <div class="cardHeader">
                        ...
                        <div class="abtn"><a href="customers copy.php">Thêm mới</a></div>
                    </div>
                    ...
                    <table class="dshd">
                        ...
                        <tr>
                            ...
                            <td><a href="editCustomers.php?id=<?php echo $rows['MAKH']?>"><?php echo "Sửa"; ?></a>
                            <a href="dltCustomers.php?id=<?php echo $rows['MAKH']?>"><?php echo "Xóa"; ?></a></td>
                        </tr>
                        <?php
                            }
                        ?>
